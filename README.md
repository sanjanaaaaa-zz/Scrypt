...
Scrypt is a secure and user-friendly personal journaling app built with the MERN stack (MongoDB, Express, React, and Node.js). It allows users to easily log in, write, view, and manage their daily entries while ensuring a seamless, distraction-free, and private experience. Prioritizing simplicity, security, and privacy, Scrypt helps you document your thoughts and memories with confidence and peace of mind.

[Live Demo](https://scrypt-mern.vercel.app)
...
│   │   │   ├── entryModel.js               # Defines the structure of scrypt entries
...
│   │   │   ├── entryRoutes.js              # Routes for scrypt entry operations
...
│   │   ├── scrypt-image.jpg               # Application banner image
...
│   │   │   │   ├── entriesApiSlice.js      # API slice for scrypt entries
...
├── package.json                            # Buld and run scripts for scrypt
...
Follow below steps to set up the scrypt project `locally`:
...
1. **Clone the repository:**
   ...
   ```bash
   git clone --branch deployment --single-branch https://github.com/sanjanaaaaa-zz/scrypt.git
   ```
...
3. **Configure Environment Variables:**
   ...
   ```env
   PORT=3000
   MONGO_URI=mongodb://localhost:27017/scrypt
   JWT_SECRET=rushB@5678
   ```

4. **Start the Scrypt by navigating to the root directory (scrypt) or backend directory fine too:**
...
Contributions are welcome! If you'd like to improve Scrypt, please follow these steps:
